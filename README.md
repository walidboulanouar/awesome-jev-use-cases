...
- [jlink](https://github.com/keltokhy/jlink) by @keltokhy. Links records under a plain-English match rule using Jev Noul pair judgments, with local candidate blocking and match resolution.
